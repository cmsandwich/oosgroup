window.gibinit = function() {
  ...
  function target_addToCart(DEBUG_NODE, UPC) {
    ...
    var cart = {"cart_type":"REGULAR","channel_id":"10","shopping_context":"DIGITAL","cart_item":{"tcin":UPC,"quantity":5,"item_channel_id":"10"},"fulfillment":{"fulfillment_test_mode":"grocery_opu_team_member_test"}};
  ...
  function gamestop_addToCart(DEBUG_NODE, UPC) {
    ...
    var cart = 'pid=' + UPC + '&quantity=5&pageSpecified=PLP&recentCheck=true&addToCartSource=RecentlyViewed';
  ...
  var wrapper = gib.createElement('div', 'gib', {
    backgroundColor: window.gibRetailer == 'target' ? 'rgba(0,136,204,0.9)' : 'rgba(0,0,0,0.9)',
    position: 'fixed',
    top: '0px',
    zIndex: 99999,
    minHeight: '300px',
